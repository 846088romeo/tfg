...
public final class ShareAgree2_ROLE_A extends AnB_Protocol<ShareAgree2_Steps,ShareAgree2_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgree2_ROLE_A(ShareAgree2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgree2_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgree2_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, ShareAgree2_Steps step) {
		...
		case STEP_0:
			...
			s.Send(s.encrypt(new AnBx_Params(Price,Desc),ShkAB));
