...
public final class ShareAgree2_ROLE_B extends AnB_Protocol<ShareAgree2_Steps,ShareAgree2_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgree2_ROLE_B(ShareAgree2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgree2_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, ShareAgree2_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, ShareAgree2_Steps step) {
		...
		case STEP_0:
			...
			eqCheck("0.1",(AnBx_Params) s.decrypt(VAR_B_R0,ShkAB),new AnBx_Params(Price,Desc));
	...
	private Crypto_ByteArray prova2(AnB_Session s,String par1,Crypto_ByteArray par2) {
		return ShareAgree2_Functions.prova2(s,par1,par2);
	}
