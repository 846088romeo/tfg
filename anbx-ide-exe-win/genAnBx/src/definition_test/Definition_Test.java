...
public class Definition_Test {
	...
	public static void main(String[] args) {
		...
		Definition_Test_CommandLine_Parser p = new Definition_Test_CommandLine_Parser(args,Definition_Test.class.getSimpleName());

        long end = System.nanoTime();
      	double durationInMs = (end - start) / 1_000_000.0;
		System.out.println(String.format("%s - Execution time was %.3f ms.", "Definition_Test [" + p.getRole() + "]", durationInMs));
