...
public final class Fresh_PublicKey_ROLE_A extends AnB_Protocol<Fresh_PublicKey_Steps,Fresh_PublicKey_Roles> {
...
//	private static boolean loop = false;
	...
	public Fresh_PublicKey_ROLE_A(Fresh_PublicKey_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_PublicKey_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_PublicKey_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_PublicKey_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, Fresh_PublicKey_Steps step) {
		...
		case STEP_1:
			...
			wffCheck("1.1",(Crypto_ByteArray) s.decrypt(VAR_A_R1,PKA));
