...
public final class ISOsymKeyOnePassUnilateralAuthProt_ROLE_B extends AnB_Protocol<ISOsymKeyOnePassUnilateralAuthProt_Steps,ISOsymKeyOnePassUnilateralAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyOnePassUnilateralAuthProt_ROLE_B(ISOsymKeyOnePassUnilateralAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyOnePassUnilateralAuthProt_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, ISOsymKeyOnePassUnilateralAuthProt_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyOnePassUnilateralAuthProt_Steps step) {
		...
		case STEP_0:
			...
			eqCheck("0.1",aliases.get("ROLE_B"),(String) new AnBx_Params((AnBx_Params) s.decrypt(VAR_B_R0,ShkAB)).getValue(1));
