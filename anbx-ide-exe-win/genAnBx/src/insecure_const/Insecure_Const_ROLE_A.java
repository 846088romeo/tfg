...
public final class Insecure_Const_ROLE_A extends AnB_Protocol<Insecure_Const_Steps,Insecure_Const_Roles> {

//	private static boolean loop = false;
	private static long sessionID = 0;

	// local knowledge - constants
	private static Crypto_ByteArray msg = new Crypto_ByteArray("msg".getBytes());
	
	// local vars
	
	
	public Insecure_Const_ROLE_A(Insecure_Const_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Insecure_Const_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Insecure_Const_Steps.STEP_0);
