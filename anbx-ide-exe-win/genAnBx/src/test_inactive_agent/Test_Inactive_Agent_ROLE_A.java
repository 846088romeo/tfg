...
public final class Test_Inactive_Agent_ROLE_A extends AnB_Protocol<Test_Inactive_Agent_Steps,Test_Inactive_Agent_Roles> {
...
//	private static boolean loop = false;
	...
	public Test_Inactive_Agent_ROLE_A(Test_Inactive_Agent_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Test_Inactive_Agent_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Test_Inactive_Agent_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, Test_Inactive_Agent_Steps step) {
		...
		case STEP_0:
			...
			s.Send(s.encrypt(new AnBx_Params(NxA,s.encrypt(NxA,aliases.get("ROLE_C")),s.encrypt(NxA,aliases.get("ROLE_C"))),aliases.get("ROLE_B")));
