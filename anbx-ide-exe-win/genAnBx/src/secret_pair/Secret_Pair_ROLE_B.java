...
public final class Secret_Pair_ROLE_B extends AnB_Protocol<Secret_Pair_Steps,Secret_Pair_Roles> {
...
//	private static boolean loop = false;
	...
	public Secret_Pair_ROLE_B(Secret_Pair_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Secret_Pair_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, Secret_Pair_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, Secret_Pair_Steps step) {
		...
		case STEP_0:
			...
			wffCheck("0.1",(Crypto_ByteArray) VAR_B_R0.getValue(0));
