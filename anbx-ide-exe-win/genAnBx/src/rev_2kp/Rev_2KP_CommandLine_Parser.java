...
public final class Rev_2KP_CommandLine_Parser extends AnBx_CommandLine_Parser<Rev_2KP_Roles,Rev_2KP_Channels> {

	public Rev_2KP_CommandLine_Parser(String[] args, String prot) {
		super(args, prot, prot, Rev_2KP_Roles.class, true);
	...
	protected void initProtocol() {
		...
		initRole(ct, role, cs, aliases, Rev_2KP_Roles.class, Rev_2KP_Channels.class);
		AnBx_Debug.out(layer, "myRole: " + role);
        AnBx_Debug.out(layer, "sessions: " + sessions);

		if (myAlias != null && keypath != null && sharepath != null) {
			Rev_2KP_pr = new Rev_2KP_Principal(myAlias, keypath, cs, aliases, crypto_config);
			switch (role) {
			case ROLE_C:
				Rev_2KP_pr.run(new Rev_2KP_ROLE_C(role, protname, sharepath),sessions);
				break;
			case ROLE_M:
				Rev_2KP_pr.run(new Rev_2KP_ROLE_M(role, protname, sharepath),sessions);
				break;
			case ROLE_a:
				Rev_2KP_pr.run(new Rev_2KP_ROLE_a(role, protname, sharepath),sessions);
				break;
