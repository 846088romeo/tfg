...
public final class Fresh_From_A_intr_ROLE_A extends AnB_Protocol<Fresh_From_A_intr_Steps,Fresh_From_A_intr_Roles> {
...
//	private static boolean loop = false;
	...
	public Fresh_From_A_intr_ROLE_A(Fresh_From_A_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_From_A_intr_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_intr_Client_Insecure, Fresh_From_A_intr_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_intr_Client_Insecure, Fresh_From_A_intr_Steps.STEP_3);
					executeStep(ROLE_A_channel_ROLE_intr_Client_Insecure, Fresh_From_A_intr_Steps.STEP_4);
	...
	protected void executeStep(AnB_Session s, Fresh_From_A_intr_Steps step) {
		...
		case STEP_3:
			...
			eqCheck("3.1",aliases.get("ROLE_B"),(String) VAR_A_DAR3INVPA.getValue(1));

			break;
		
		case STEP_4:
			
			s.Send(s.sign(new AnBx_Params((Crypto_ByteArray) VAR_A_DAR3INVPA.getValue(0),aliases.get("ROLE_B"),Msg)));
