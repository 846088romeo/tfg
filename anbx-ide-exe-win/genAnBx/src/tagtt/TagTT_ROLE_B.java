...
public final class TagTT_ROLE_B extends AnB_Protocol<TagTT_Steps,TagTT_Roles> {
...
//	private static boolean loop = false;
	...
	public TagTT_ROLE_B(TagTT_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		TagTT_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, TagTT_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, TagTT_Steps step) {
	...
	private Crypto_ByteArray f(AnB_Session s,Crypto_ByteArray par1) {
		return TagTT_Functions.f(s,par1);
	}
