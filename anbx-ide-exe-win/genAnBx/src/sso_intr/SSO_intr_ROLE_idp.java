...
public final class SSO_intr_ROLE_idp extends AnB_Protocol<SSO_intr_Steps,SSO_intr_Roles> {
...
//	private static boolean loop = false;
	...
	// local vars
	private AnBx_Params VAR_IDP_R5 = null;
	
	
	public SSO_intr_ROLE_idp(SSO_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		SSO_intr_ROLE_idp.sessions = sessions;
		
		AnB_Session ROLE_idp_channel_ROLE_intr_Server_Secure = lbs.get("ROLE_idp_channel_ROLE_intr_Server_Secure");
        
		init();
		
        ROLE_idp_channel_ROLE_intr_Server_Secure.Open();
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_idp_channel_ROLE_intr_Server_Secure, SSO_intr_Steps.STEP_5);
					executeStep(ROLE_idp_channel_ROLE_intr_Server_Secure, SSO_intr_Steps.STEP_6);
        ...
        ROLE_idp_channel_ROLE_intr_Server_Secure.Close();
	...
	protected void executeStep(AnB_Session s, SSO_intr_Steps step) {
		...
		case STEP_5:
			...
			VAR_IDP_R5 = (AnBx_Params) s.Receive();
			eqCheck("5.1",aliases.get("ROLE_C"),(String) VAR_IDP_R5.getValue(0));
			eqCheck("5.2",aliases.get("ROLE_idp"),(String) VAR_IDP_R5.getValue(1));

			break;
		
		case STEP_6:
			
			s.Send(new AnBx_Params(s.sign(new AnBx_Params(aliases.get("ROLE_C"),aliases.get("ROLE_idp"))),(Crypto_ByteArray) VAR_IDP_R5.getValue(4)));
