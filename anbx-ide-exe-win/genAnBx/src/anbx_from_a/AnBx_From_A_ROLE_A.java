...
public final class AnBx_From_A_ROLE_A extends AnB_Protocol<AnBx_From_A_Steps,AnBx_From_A_Roles> {
...
//	private static boolean loop = false;
	...
	public AnBx_From_A_ROLE_A(AnBx_From_A_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_From_A_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_From_A_Steps.STEP_0);
