...
public final class AndrewSecureRPC_intr2_ROLE_intr extends AnB_Protocol<AndrewSecureRPC_intr2_Steps,AndrewSecureRPC_intr2_Roles> {
...
//	private static boolean loop = false;
	...
	public AndrewSecureRPC_intr2_ROLE_intr(AndrewSecureRPC_intr2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AndrewSecureRPC_intr2_ROLE_intr.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, AndrewSecureRPC_intr2_Steps.STEP_0);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, AndrewSecureRPC_intr2_Steps.STEP_1);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, AndrewSecureRPC_intr2_Steps.STEP_2);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, AndrewSecureRPC_intr2_Steps.STEP_3);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, AndrewSecureRPC_intr2_Steps.STEP_4);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, AndrewSecureRPC_intr2_Steps.STEP_5);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, AndrewSecureRPC_intr2_Steps.STEP_6);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, AndrewSecureRPC_intr2_Steps.STEP_7);
