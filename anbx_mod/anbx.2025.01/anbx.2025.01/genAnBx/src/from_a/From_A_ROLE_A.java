...
public final class From_A_ROLE_A extends AnB_Protocol<From_A_Steps,From_A_Roles> {
...
//	private static boolean loop = false;
	...
	public From_A_ROLE_A(From_A_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		From_A_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, From_A_Steps.STEP_0);
