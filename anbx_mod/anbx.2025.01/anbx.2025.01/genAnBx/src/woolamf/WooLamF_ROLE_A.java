...
public final class WooLamF_ROLE_A extends AnB_Protocol<WooLamF_Steps,WooLamF_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLamF_ROLE_A(WooLamF_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLamF_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLamF_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLamF_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLamF_Steps.STEP_2);
