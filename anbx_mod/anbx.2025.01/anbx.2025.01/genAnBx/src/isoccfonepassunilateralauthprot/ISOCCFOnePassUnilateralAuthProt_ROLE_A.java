...
public final class ISOCCFOnePassUnilateralAuthProt_ROLE_A extends AnB_Protocol<ISOCCFOnePassUnilateralAuthProt_Steps,ISOCCFOnePassUnilateralAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOCCFOnePassUnilateralAuthProt_ROLE_A(ISOCCFOnePassUnilateralAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOCCFOnePassUnilateralAuthProt_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOCCFOnePassUnilateralAuthProt_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, ISOCCFOnePassUnilateralAuthProt_Steps step) {
		...
		case STEP_0:
			...
			NxA = s.getNonce();
			Text2 = s.getNonce();
			s.Send(new AnBx_Params(NxA,aliases.get("ROLE_B"),Text2,s.encrypt(new AnBx_Params(NxA,aliases.get("ROLE_B"),Text1),ShkAB),NxA,aliases.get("ROLE_B"),Text1));
