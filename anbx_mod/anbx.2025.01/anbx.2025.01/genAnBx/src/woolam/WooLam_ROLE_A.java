...
public final class WooLam_ROLE_A extends AnB_Protocol<WooLam_Steps,WooLam_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLam_ROLE_A(WooLam_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLam_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, WooLam_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.encrypt(VAR_A_R1,ShkAs));
