...
public final class Secret_Goal_Pair_ROLE_A extends AnB_Protocol<Secret_Goal_Pair_Steps,Secret_Goal_Pair_Roles> {
...
//	private static boolean loop = false;
	...
	private Crypto_ByteArray Msg2 = null;
	private AnBx_Params VAR_A_R1 = null;
	
	
	public Secret_Goal_Pair_ROLE_A(Secret_Goal_Pair_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Secret_Goal_Pair_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Secret_Goal_Pair_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Secret_Goal_Pair_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, Secret_Goal_Pair_Steps step) {
		...
		case STEP_0:
			...
			Msg1 = s.getNonce();
			Msg2 = s.getNonce();
			s.Send(s.encrypt(new AnBx_Params(Msg1,Msg2),aliases.get("ROLE_B")));
		...
		case STEP_1:
			...
			eqCheck("1.1",VAR_A_R1,new AnBx_Params(Msg1,Msg2));
