...
public final class From_A_Secret_CommandLine_Parser extends AnBx_CommandLine_Parser<From_A_Secret_Roles,From_A_Secret_Channels> {

	public From_A_Secret_CommandLine_Parser(String[] args, String prot) {
		super(args, prot, prot, From_A_Secret_Roles.class, true);
	...
	protected void initProtocol() {
		...
		initRole(ct, role, cs, aliases, From_A_Secret_Roles.class, From_A_Secret_Channels.class);
		...
		if (myAlias != null && keypath != null && sharepath != null) {
			...
			switch (role) {
			case ROLE_A:
				From_A_Secret_pr.run(new From_A_Secret_ROLE_A(role, protname, sharepath),sessions);
				break;
			case ROLE_B:
				From_A_Secret_pr.run(new From_A_Secret_ROLE_B(role, protname, sharepath),sessions);
				break;
