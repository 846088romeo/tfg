...
public final class AnBx_From_A_secret_for_B_C_honest_ROLE_A extends AnB_Protocol<AnBx_From_A_secret_for_B_C_honest_Steps,AnBx_From_A_secret_for_B_C_honest_Roles> {
...
//	private static boolean loop = false;
	...
	public AnBx_From_A_secret_for_B_C_honest_ROLE_A(AnBx_From_A_secret_for_B_C_honest_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_From_A_secret_for_B_C_honest_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_From_A_secret_for_B_C_honest_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, AnBx_From_A_secret_for_B_C_honest_Steps step) {
		...
		case STEP_0:
			...
			s.Send(s.encrypt(s.sign(new AnBx_Params(aliases.get("ROLE_B"),aliases.get("ROLE_c"),Msg)),aliases.get("ROLE_B")));
