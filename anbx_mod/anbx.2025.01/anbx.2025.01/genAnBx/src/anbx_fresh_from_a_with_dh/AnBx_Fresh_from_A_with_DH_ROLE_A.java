...
public final class AnBx_Fresh_from_A_with_DH_ROLE_A extends AnB_Protocol<AnBx_Fresh_from_A_with_DH_Steps,AnBx_Fresh_from_A_with_DH_Roles> {
...
//	private static boolean loop = false;
	...
	private SignedObject VAR_A_EBMSGINVSA = null;
	
	
	public AnBx_Fresh_from_A_with_DH_ROLE_A(AnBx_Fresh_from_A_with_DH_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_Fresh_from_A_with_DH_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_Fresh_from_A_with_DH_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_Fresh_from_A_with_DH_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_Fresh_from_A_with_DH_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, AnBx_Fresh_from_A_with_DH_Steps step) {
		...
		case STEP_0:
			...
			s.Send(s.getKeyEx_PublicKey(XxX));
		...
		case STEP_2:
			...
			VAR_A_EBMSGINVSA = s.sign(new AnBx_Params(aliases.get("ROLE_B"),Msg));
			s.Send(new AnBx_Params(s.encrypt(new AnBx_Params((Crypto_ByteArray) VAR_A_DAR1INVPA.getValue(1),s.makeDigest(VAR_A_EBMSGINVSA)),s.getKeyEx_SecretKey((PublicKey) VAR_A_DAR1INVPA.getValue(0),XxX)),VAR_A_EBMSGINVSA));
