...
public final class ShareAgree_ROLE_A extends AnB_Protocol<ShareAgree_Steps,ShareAgree_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgree_ROLE_A(ShareAgree_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgree_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgree_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgree_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgree_Steps.STEP_2);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgree_Steps.STEP_3);
	...
	protected void executeStep(AnB_Session s, ShareAgree_Steps step) {
		...
		case STEP_0:
			...
			VAR_A_SHKAB = ShkAB;
			s.Send(s.encrypt(Price,VAR_A_SHKAB));
		...
		case STEP_1:
			...
			eqCheck("1.1",Desc,(Crypto_ByteArray) s.decrypt(VAR_A_R1,VAR_A_SHKAB));
		...
		case STEP_2:
			...
			Msg = s.getNonce();
			s.Send(new AnBx_Params(empty,Msg));
		...
		case STEP_3:
			...
			eqCheck("3.1",prova(s,aliases.get("ROLE_A"),aliases.get("ROLE_B")),VAR_A_R3);
