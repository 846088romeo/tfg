...
public final class Bullet_Channel_Expansion_Secure_ROLE_A extends AnB_Protocol<Bullet_Channel_Expansion_Secure_Steps,Bullet_Channel_Expansion_Secure_Roles> {
...
//	private static boolean loop = false;
	...
	public Bullet_Channel_Expansion_Secure_ROLE_A(Bullet_Channel_Expansion_Secure_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Bullet_Channel_Expansion_Secure_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Secure, Bullet_Channel_Expansion_Secure_Steps.STEP_0);
