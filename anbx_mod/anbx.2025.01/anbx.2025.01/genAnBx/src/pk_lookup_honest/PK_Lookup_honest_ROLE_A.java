...
public final class PK_Lookup_honest_ROLE_A extends AnB_Protocol<PK_Lookup_honest_Steps,PK_Lookup_honest_Roles> {
...
//	private static boolean loop = false;
	...
	public PK_Lookup_honest_ROLE_A(PK_Lookup_honest_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		PK_Lookup_honest_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_b_Client_Insecure, PK_Lookup_honest_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_b_Client_Insecure, PK_Lookup_honest_Steps.STEP_1);
