...
public final class ISOsymKeyTwoPassMutualAuthProtCorr_ROLE_A extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProtCorr_Steps,ISOsymKeyTwoPassMutualAuthProtCorr_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassMutualAuthProtCorr_ROLE_A(ISOsymKeyTwoPassMutualAuthProtCorr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProtCorr_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassMutualAuthProtCorr_Steps step) {
		...
		case STEP_0:
			...
			NA = s.getNonce();
			VAR_A_SHKAB = ShkAB;
			s.Send(s.encrypt(new AnBx_Params(NA,aliases.get("ROLE_B"),Text1,tag),VAR_A_SHKAB));
