...
public final class TLS_pw_ROLE_s extends AnB_Protocol<TLS_pw_Steps,TLS_pw_Roles> {
...
//	private static boolean loop = false;
	...
	public TLS_pw_ROLE_s(TLS_pw_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		TLS_pw_ROLE_s.sessions = sessions;
		
		AnB_Session ROLE_s_channel_ROLE_B_Client_Secure = lbs.get("ROLE_s_channel_ROLE_B_Client_Secure");
        
		init();
		
        ROLE_s_channel_ROLE_B_Client_Secure.Open();
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_s_channel_ROLE_B_Client_Secure, TLS_pw_Steps.STEP_0);
        ...
        ROLE_s_channel_ROLE_B_Client_Secure.Close();
