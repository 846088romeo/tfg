...
public final class SharedKey_ROLE_A extends AnB_Protocol<SharedKey_Steps,SharedKey_Roles> {
...
//	private static boolean loop = false;
	...
	public SharedKey_ROLE_A(SharedKey_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		SharedKey_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, SharedKey_Steps.STEP_0);
