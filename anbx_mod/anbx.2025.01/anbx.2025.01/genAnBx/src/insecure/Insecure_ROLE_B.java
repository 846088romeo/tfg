...
public final class Insecure_ROLE_B extends AnB_Protocol<Insecure_Steps,Insecure_Roles> {
...
//	private static boolean loop = false;
	...
	public Insecure_ROLE_B(Insecure_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Insecure_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, Insecure_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, Insecure_Steps step) {
