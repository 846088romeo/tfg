...
public final class ISOCCFTwoPassUnilateralAuthProt_Functions {
	...
	public static Crypto_ByteArray f(AnB_Session s,SecretKey par1,Crypto_ByteArray par2,String par3,Crypto_ByteArray par4) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()+par2.hashCode()+par3.hashCode()+par4.hashCode()).getBytes());
	}
