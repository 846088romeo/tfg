...
public final class ShareAgreeSimple_ROLE_A extends AnB_Protocol<ShareAgreeSimple_Steps,ShareAgreeSimple_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgreeSimple_ROLE_A(ShareAgreeSimple_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgreeSimple_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgreeSimple_Steps.STEP_0);
