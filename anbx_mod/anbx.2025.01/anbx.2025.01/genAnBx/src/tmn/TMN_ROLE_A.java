...
public final class TMN_ROLE_A extends AnB_Protocol<TMN_Steps,TMN_Roles> {
...
//	private static boolean loop = false;
	...
	// local vars
	private Crypto_ByteArray Ka = null;
	private Crypto_ByteArray VAR_A_R3 = null;
	
	
	public TMN_ROLE_A(TMN_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_s_Client_Insecure, TMN_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_s_Client_Insecure, TMN_Steps.STEP_3);
	...
	protected void executeStep(AnB_Session s, TMN_Steps step) {
		...
		case STEP_0:
			...
			Ka = s.getNonce();
			s.Send(s.encrypt(Ka,aliases.get("ROLE_s")));
		...
		case STEP_3:
			...
			eqCheck("3.1",VAR_A_R3,s.xor(Ka,s.xor(VAR_A_R3,Ka)));
