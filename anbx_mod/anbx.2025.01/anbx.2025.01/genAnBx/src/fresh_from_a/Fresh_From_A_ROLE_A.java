...
public final class Fresh_From_A_ROLE_A extends AnB_Protocol<Fresh_From_A_Steps,Fresh_From_A_Roles> {
...
//	private static boolean loop = false;
	...
	public Fresh_From_A_ROLE_A(Fresh_From_A_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_From_A_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, Fresh_From_A_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.sign(new AnBx_Params((Crypto_ByteArray) VAR_A_DAR1INVPA.getValue(0),aliases.get("ROLE_B"),Msg)));
