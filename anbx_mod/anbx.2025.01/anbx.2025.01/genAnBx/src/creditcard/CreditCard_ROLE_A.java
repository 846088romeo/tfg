...
public final class CreditCard_ROLE_A extends AnB_Protocol<CreditCard_Steps,CreditCard_Roles> {
...
//	private static boolean loop = false;
	...
	public CreditCard_ROLE_A(CreditCard_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		CreditCard_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_M_Server_Insecure, CreditCard_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, CreditCard_Steps step) {
