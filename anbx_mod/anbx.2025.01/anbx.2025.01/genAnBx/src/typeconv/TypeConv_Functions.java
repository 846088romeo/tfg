...
// custom types
class IntNum extends RandomCrypto_ByteArray { private static final long serialVersionUID = 1L; public IntNum(byte[] bytes) {super();}  public IntNum() {super();}};


public final class TypeConv_Functions {
