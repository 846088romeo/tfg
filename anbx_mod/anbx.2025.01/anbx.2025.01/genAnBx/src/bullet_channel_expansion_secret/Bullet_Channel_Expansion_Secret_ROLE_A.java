...
public final class Bullet_Channel_Expansion_Secret_ROLE_A extends AnB_Protocol<Bullet_Channel_Expansion_Secret_Steps,Bullet_Channel_Expansion_Secret_Roles> {
...
//	private static boolean loop = false;
	...
	public Bullet_Channel_Expansion_Secret_ROLE_A(Bullet_Channel_Expansion_Secret_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Bullet_Channel_Expansion_Secret_ROLE_A.sessions = sessions;
		
		AnB_Session ROLE_A_channel_ROLE_B_Client_Confidential = lbs.get("ROLE_A_channel_ROLE_B_Client_Confidential");
        
		init();
		
        ROLE_A_channel_ROLE_B_Client_Confidential.Open();
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Confidential, Bullet_Channel_Expansion_Secret_Steps.STEP_0);
        ...
        ROLE_A_channel_ROLE_B_Client_Confidential.Close();
