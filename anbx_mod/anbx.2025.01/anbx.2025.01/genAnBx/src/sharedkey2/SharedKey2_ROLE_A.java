...
public final class SharedKey2_ROLE_A extends AnB_Protocol<SharedKey2_Steps,SharedKey2_Roles> {
...
//	private static boolean loop = false;
	...
	public SharedKey2_ROLE_A(SharedKey2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		SharedKey2_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, SharedKey2_Steps.STEP_0);
