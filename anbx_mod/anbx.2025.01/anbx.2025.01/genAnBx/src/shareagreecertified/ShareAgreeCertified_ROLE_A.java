...
public final class ShareAgreeCertified_ROLE_A extends AnB_Protocol<ShareAgreeCertified_Steps,ShareAgreeCertified_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgreeCertified_ROLE_A(ShareAgreeCertified_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgreeCertified_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgreeCertified_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgreeCertified_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgreeCertified_Steps.STEP_2);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ShareAgreeCertified_Steps.STEP_3);
