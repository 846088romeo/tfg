...
public final class AnBx_BlindForwarding_ROLE_C extends AnB_Protocol<AnBx_BlindForwarding_Steps,AnBx_BlindForwarding_Roles> {
...
//	private static boolean loop = false;
	...
	public AnBx_BlindForwarding_ROLE_C(AnBx_BlindForwarding_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_BlindForwarding_ROLE_C.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_C_channel_ROLE_M_Client_Insecure, AnBx_BlindForwarding_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, AnBx_BlindForwarding_Steps step) {
		...
		case STEP_0:
			...
			s.Send(s.encrypt(s.sign(new AnBx_Params(aliases.get("ROLE_A"),CcnCA)),aliases.get("ROLE_A")));
