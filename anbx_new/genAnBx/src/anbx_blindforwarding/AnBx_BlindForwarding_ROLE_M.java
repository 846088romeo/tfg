...
public final class AnBx_BlindForwarding_ROLE_M extends AnB_Protocol<AnBx_BlindForwarding_Steps,AnBx_BlindForwarding_Roles> {
...
//	private static boolean loop = false;
	...
	public AnBx_BlindForwarding_ROLE_M(AnBx_BlindForwarding_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_BlindForwarding_ROLE_M.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_M_channel_ROLE_C_Server_Insecure, AnBx_BlindForwarding_Steps.STEP_0);
					executeStep(ROLE_M_channel_ROLE_A_Client_Insecure, AnBx_BlindForwarding_Steps.STEP_1);
