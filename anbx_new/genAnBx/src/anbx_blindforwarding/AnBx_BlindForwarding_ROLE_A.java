...
public final class AnBx_BlindForwarding_ROLE_A extends AnB_Protocol<AnBx_BlindForwarding_Steps,AnBx_BlindForwarding_Roles> {
...
//	private static boolean loop = false;
	...
	private AnBx_Params VAR_A_DDAR1INVPASC = null;
	
	
	public AnBx_BlindForwarding_ROLE_A(AnBx_BlindForwarding_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_BlindForwarding_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_M_Server_Insecure, AnBx_BlindForwarding_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, AnBx_BlindForwarding_Steps step) {
		...
		case STEP_1:
			...
			VAR_A_DDAR1INVPASC = (AnBx_Params) s.verify((SignedObject) s.decrypt(VAR_A_R1),aliases.get("ROLE_C"));
			wffCheck("1.1",(Crypto_ByteArray) VAR_A_DDAR1INVPASC.getValue(1));
			eqCheck("1.2",VAR_A_DDAR1INVPASC,new AnBx_Params(aliases.get("ROLE_A"),CcnCA));
