...
public final class KeyEx5_ROLE_B extends AnB_Protocol<KeyEx5_Steps,KeyEx5_Roles> {
...
//	private static boolean loop = false;
	...
	public KeyEx5_ROLE_B(KeyEx5_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		KeyEx5_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Client_Insecure, KeyEx5_Steps.STEP_0);
					executeStep(ROLE_B_channel_ROLE_A_Client_Insecure, KeyEx5_Steps.STEP_3);
	...
	protected void executeStep(AnB_Session s, KeyEx5_Steps step) {
		...
		case STEP_3:
			...
			eqCheck("3.2",NB,(Crypto_ByteArray) VAR_B_DSBR3SHKBS.getValue(2));
