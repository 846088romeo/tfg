...
public final class ISOSK2PMAP_I1_ROLE_intr extends AnB_Protocol<ISOSK2PMAP_I1_Steps,ISOSK2PMAP_I1_Roles> {
...
//	private static boolean loop = false;
	...
	private SealedObject VAR_INTR_REPLAY_R1 = null;
	
	
	public ISOSK2PMAP_I1_ROLE_intr(ISOSK2PMAP_I1_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOSK2PMAP_I1_ROLE_intr.sessions = sessions;
		
		AnB_Session ROLE_intr_channel_ROLE_A_Server_Insecure = lbs.get("ROLE_intr_channel_ROLE_A_Server_Insecure");
        AnB_Session ROLE_intr_channel_ROLE_B_Server_Insecure = lbs.get("ROLE_intr_channel_ROLE_B_Server_Insecure");
        
		init();
		
        ROLE_intr_channel_ROLE_A_Server_Insecure.Open();
		ROLE_intr_channel_ROLE_B_Server_Insecure.Open();
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOSK2PMAP_I1_Steps.STEP_0);
					executeStep(ROLE_intr_channel_ROLE_B_Server_Insecure, ISOSK2PMAP_I1_Steps.STEP_1);
					executeStep(ROLE_intr_channel_ROLE_B_Server_Insecure, ISOSK2PMAP_I1_Steps.STEP_2);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOSK2PMAP_I1_Steps.STEP_3);
		...
		ROLE_intr_channel_ROLE_B_Server_Insecure.Close();
	...
	protected void executeStep(AnB_Session s, ISOSK2PMAP_I1_Steps step) {
		...
		case STEP_1:
			...
			if (VAR_INTR_REPLAY_R1 == null || !(new Random().nextInt(10) < 5)) {
				AnBx_Debug.out(layer, ">>> NO ATTACK <<<");
				VAR_INTR_REPLAY_R1 = VAR_INTR_R0;
				s.Send(VAR_INTR_R0);
			} else {
				// Simulate attack by sending previous message
				AnBx_Debug.out(layer, ">>> ATTACK <<<");
				s.Send(VAR_INTR_REPLAY_R1);
			}
