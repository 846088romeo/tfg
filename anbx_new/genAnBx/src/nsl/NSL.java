...
public class NSL {
	...
	public static void main(String[] args) {
		...
		NSL_CommandLine_Parser p = new NSL_CommandLine_Parser(args,NSL.class.getSimpleName());

        long end = System.nanoTime();
      	double durationInMs = (end - start) / 1_000_000.0;
		System.out.println(String.format("%s - Execution time was %.3f ms.", "NSL [" + p.getRole() + "]", durationInMs));
