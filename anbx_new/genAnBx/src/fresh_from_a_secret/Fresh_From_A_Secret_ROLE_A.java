...
public final class Fresh_From_A_Secret_ROLE_A extends AnB_Protocol<Fresh_From_A_Secret_Steps,Fresh_From_A_Secret_Roles> {
...
//	private static boolean loop = false;
	...
	public Fresh_From_A_Secret_ROLE_A(Fresh_From_A_Secret_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_From_A_Secret_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Secret_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Secret_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_From_A_Secret_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, Fresh_From_A_Secret_Steps step) {
		...
		case STEP_1:
			...
			wffCheck("1.1",Crypto_KeyStoreType.sk());
			VAR_A_DAR1INVPA = (AnBx_Params) s.decrypt(VAR_A_R1);
			eqCheck("1.2",aliases.get("ROLE_B"),(String) VAR_A_DAR1INVPA.getValue(1));

			break;
		
		case STEP_2:
			
			s.Send(s.encrypt(s.sign(new AnBx_Params((Crypto_ByteArray) VAR_A_DAR1INVPA.getValue(0),aliases.get("ROLE_B"),Msg)),aliases.get("ROLE_B")));
