...
public final class WooLam1_ROLE_A extends AnB_Protocol<WooLam1_Steps,WooLam1_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLam1_ROLE_A(WooLam1_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLam1_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, WooLam1_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.encrypt(new AnBx_Params(aliases.get("ROLE_A"),aliases.get("ROLE_B"),VAR_A_R1),ShkAs));
