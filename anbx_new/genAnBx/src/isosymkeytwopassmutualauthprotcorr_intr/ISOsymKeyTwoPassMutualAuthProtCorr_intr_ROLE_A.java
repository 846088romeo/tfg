...
public final class ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_A extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps,ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_A(ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_intr_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_intr_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_3);
