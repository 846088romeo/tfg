...
public final class ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_intr extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps,ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles> {
...
//	private static boolean loop = false;
	...
	// local vars
	private SealedObject VAR_INTR_R0 = null;
	private SealedObject VAR_INTR_R2 = null;
	private SealedObject VAR_INTR_REPLAY_R3 = null;
	
	
	public ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_intr(ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_intr.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_0);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_1);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_2);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_3);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps step) {
		...
		case STEP_0:
			...
			VAR_INTR_R0 = (SealedObject) s.Receive();
		...
		case STEP_3:
			...
			if (VAR_INTR_REPLAY_R3 == null || !(new Random().nextInt(10) < 4)) {
				AnBx_Debug.out(layer, ">>> NO ATTACK <<<");
				VAR_INTR_REPLAY_R3 = VAR_INTR_R2;
				s.Send(VAR_INTR_R2);
			} else {
				// Simulate attack by sending previous message
				AnBx_Debug.out(layer, ">>> ATTACK <<<");
				s.Send(VAR_INTR_REPLAY_R3);
			}
