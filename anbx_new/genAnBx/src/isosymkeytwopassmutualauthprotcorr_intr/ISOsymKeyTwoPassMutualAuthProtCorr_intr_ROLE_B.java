...
public final class ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_B extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps,ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_B(ISOsymKeyTwoPassMutualAuthProtCorr_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProtCorr_intr_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_intr_Server_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_1);
					executeStep(ROLE_B_channel_ROLE_intr_Server_Insecure, ISOsymKeyTwoPassMutualAuthProtCorr_intr_Steps.STEP_2);
