...
public final class Insecure_ROLE_A extends AnB_Protocol<Insecure_Steps,Insecure_Roles> {
...
//	private static boolean loop = false;
	...
	public Insecure_ROLE_A(Insecure_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Insecure_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Insecure_Steps.STEP_0);
