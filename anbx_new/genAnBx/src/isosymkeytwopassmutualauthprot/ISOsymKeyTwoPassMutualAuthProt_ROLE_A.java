...
public final class ISOsymKeyTwoPassMutualAuthProt_ROLE_A extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProt_Steps,ISOsymKeyTwoPassMutualAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassMutualAuthProt_ROLE_A(ISOsymKeyTwoPassMutualAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProt_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProt_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProt_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassMutualAuthProt_Steps step) {
		...
		case STEP_1:
			...
			wffCheck("1.1",(Crypto_ByteArray) VAR_A_DSAR1ASHKAB.getValue(0));
			wffCheck("1.2",(Crypto_ByteArray) VAR_A_DSAR1ASHKAB.getValue(2));
			eqCheck("1.3",aliases.get("ROLE_A"),(String) VAR_A_DSAR1ASHKAB.getValue(1));
