...
public final class Fresh_PublicKey_Sign_ROLE_A extends AnB_Protocol<Fresh_PublicKey_Sign_Steps,Fresh_PublicKey_Sign_Roles> {
...
//	private static boolean loop = false;
	...
	// local vars
	private Crypto_KeyPair PKA = null;
	private Crypto_ByteArray Msg = null;
	private Crypto_ByteArray VAR_A_R1 = null;
	
	
	public Fresh_PublicKey_Sign_ROLE_A(Fresh_PublicKey_Sign_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_PublicKey_Sign_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_PublicKey_Sign_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_PublicKey_Sign_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_PublicKey_Sign_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, Fresh_PublicKey_Sign_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.sign(new AnBx_Params(aliases.get("ROLE_B"),Msg),PKA));
