...
public final class ISOCCFTwoPassMutualAuthProtCorr_Functions {
	...
	public static Crypto_ByteArray f(AnB_Session s,Object ... par1) {
		// TODO Auto-generated method stub
		int hash = 0;
		for (Object obj : par1)
			hash = hash + obj.hashCode() ;
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(hash).getBytes());
	}
