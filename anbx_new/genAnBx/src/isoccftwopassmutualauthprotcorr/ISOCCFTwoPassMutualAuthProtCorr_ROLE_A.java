...
public final class ISOCCFTwoPassMutualAuthProtCorr_ROLE_A extends AnB_Protocol<ISOCCFTwoPassMutualAuthProtCorr_Steps,ISOCCFTwoPassMutualAuthProtCorr_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOCCFTwoPassMutualAuthProtCorr_ROLE_A(ISOCCFTwoPassMutualAuthProtCorr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOCCFTwoPassMutualAuthProtCorr_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOCCFTwoPassMutualAuthProtCorr_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOCCFTwoPassMutualAuthProtCorr_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, ISOCCFTwoPassMutualAuthProtCorr_Steps step) {
		...
		case STEP_0:
			...
			NxA = s.getNonce();
			VAR_A_SHKAB = ShkAB;
			s.Send(new AnBx_Params(f(s,VAR_A_SHKAB,NxA,aliases.get("ROLE_B"),Text1,tag),NxA,aliases.get("ROLE_B"),Text1));
		...
		case STEP_1:
			...
			eqCheck("1.1",aliases.get("ROLE_A"),(String) VAR_A_R1.getValue(2));
			eqCheck("1.2",(Crypto_ByteArray) VAR_A_R1.getValue(0),f(s,VAR_A_SHKAB,(Crypto_ByteArray) VAR_A_R1.getValue(1),aliases.get("ROLE_A"),(Crypto_ByteArray) VAR_A_R1.getValue(3)));
	...
	private Crypto_ByteArray f(AnB_Session s,Object ... par1) {
		return ISOCCFTwoPassMutualAuthProtCorr_Functions.f(s,par1);
	}
