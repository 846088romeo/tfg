...
public final class WooLam3_ROLE_A extends AnB_Protocol<WooLam3_Steps,WooLam3_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLam3_ROLE_A(WooLam3_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLam3_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam3_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam3_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam3_Steps.STEP_2);
