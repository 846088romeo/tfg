...
public final class From_A_Mutual_ROLE_A extends AnB_Protocol<From_A_Mutual_Steps,From_A_Mutual_Roles> {
...
//	private static boolean loop = false;
	...
	public From_A_Mutual_ROLE_A(From_A_Mutual_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		From_A_Mutual_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, From_A_Mutual_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, From_A_Mutual_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, From_A_Mutual_Steps step) {
		...
		case STEP_1:
			...
			eqCheck("1.1",(AnBx_Params) s.verify(VAR_A_R1,aliases.get("ROLE_B")),new AnBx_Params(aliases.get("ROLE_A"),Msg));
