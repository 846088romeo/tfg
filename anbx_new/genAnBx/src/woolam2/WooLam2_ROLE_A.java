...
public final class WooLam2_ROLE_A extends AnB_Protocol<WooLam2_Steps,WooLam2_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLam2_ROLE_A(WooLam2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLam2_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam2_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam2_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam2_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, WooLam2_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.encrypt(new AnBx_Params(aliases.get("ROLE_A"),VAR_A_R1),ShkAs));
