...
public final class SharedKey_ROLE_B extends AnB_Protocol<SharedKey_Steps,SharedKey_Roles> {
...
//	private static boolean loop = false;
	...
	public SharedKey_ROLE_B(SharedKey_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		SharedKey_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, SharedKey_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, SharedKey_Steps step) {
