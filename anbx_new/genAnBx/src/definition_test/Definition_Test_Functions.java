...
public final class Definition_Test_Functions {
	...
	public static Crypto_ByteArray fun1(AnB_Session s,String par1,Crypto_ByteArray par2) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()+par2.hashCode()).getBytes());
	}
	
	public static Crypto_ByteArray fun2(AnB_Session s,String par1,Crypto_ByteArray par2) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()+par2.hashCode()).getBytes());
	}
	
	public static Crypto_ByteArray fun3(AnB_Session s,String par1,Crypto_ByteArray par2) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()+par2.hashCode()).getBytes());
	}
	
	public static Crypto_ByteArray fun4(AnB_Session s,String par1) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()).getBytes());
	}
	
	public static Crypto_ByteArray fun5(AnB_Session s,String par1,Crypto_ByteArray par2) {
		// TODO Auto-generated method stub
