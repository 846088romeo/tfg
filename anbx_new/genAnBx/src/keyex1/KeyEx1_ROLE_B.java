...
public final class KeyEx1_ROLE_B extends AnB_Protocol<KeyEx1_Steps,KeyEx1_Roles> {
...
//	private static boolean loop = false;
	...
	public KeyEx1_ROLE_B(KeyEx1_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		KeyEx1_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, KeyEx1_Steps.STEP_2);
