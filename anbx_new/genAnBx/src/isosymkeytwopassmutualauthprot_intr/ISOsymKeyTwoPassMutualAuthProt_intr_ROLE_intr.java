...
public final class ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_intr extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProt_intr_Steps,ISOsymKeyTwoPassMutualAuthProt_intr_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_intr(ISOsymKeyTwoPassMutualAuthProt_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_intr.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_0);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_1);
					executeStep(ROLE_intr_channel_ROLE_B_Client_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_2);
					executeStep(ROLE_intr_channel_ROLE_A_Server_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_3);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassMutualAuthProt_intr_Steps step) {
		...
		case STEP_3:
			...
			if (VAR_INTR_REPLAY_R3 == null || !(new Random().nextInt(10) < 5)) {
