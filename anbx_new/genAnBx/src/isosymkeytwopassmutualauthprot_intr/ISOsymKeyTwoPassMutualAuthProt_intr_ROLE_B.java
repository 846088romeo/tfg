...
public final class ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_B extends AnB_Protocol<ISOsymKeyTwoPassMutualAuthProt_intr_Steps,ISOsymKeyTwoPassMutualAuthProt_intr_Roles> {
...
//	private static boolean loop = false;
	...
	private AnBx_Params VAR_B_DSBR1SHKAB = null;
	
	
	public ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_B(ISOsymKeyTwoPassMutualAuthProt_intr_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassMutualAuthProt_intr_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_intr_Server_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_1);
					executeStep(ROLE_B_channel_ROLE_intr_Server_Insecure, ISOsymKeyTwoPassMutualAuthProt_intr_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassMutualAuthProt_intr_Steps step) {
		...
		case STEP_1:
			...
			VAR_B_DSBR1SHKAB = (AnBx_Params) s.decrypt(VAR_B_R1,ShkAB);
			wffCheck("1.1",(Crypto_ByteArray) VAR_B_DSBR1SHKAB.getValue(0));
			wffCheck("1.2",(Crypto_ByteArray) VAR_B_DSBR1SHKAB.getValue(2));
			eqCheck("1.3",aliases.get("ROLE_B"),(String) VAR_B_DSBR1SHKAB.getValue(1));
