...
public final class SharedKey2_ROLE_B extends AnB_Protocol<SharedKey2_Steps,SharedKey2_Roles> {
...
//	private static boolean loop = false;
	...
	public SharedKey2_ROLE_B(SharedKey2_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		SharedKey2_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, SharedKey2_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, SharedKey2_Steps step) {
