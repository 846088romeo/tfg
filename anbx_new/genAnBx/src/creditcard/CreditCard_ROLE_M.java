...
public final class CreditCard_ROLE_M extends AnB_Protocol<CreditCard_Steps,CreditCard_Roles> {
...
//	private static boolean loop = false;
	...
	public CreditCard_ROLE_M(CreditCard_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		CreditCard_ROLE_M.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_M_channel_ROLE_C_Server_Insecure, CreditCard_Steps.STEP_0);
					executeStep(ROLE_M_channel_ROLE_A_Client_Insecure, CreditCard_Steps.STEP_1);
