...
public final class CreditCard_ROLE_C extends AnB_Protocol<CreditCard_Steps,CreditCard_Roles> {
...
//	private static boolean loop = false;
	...
	public CreditCard_ROLE_C(CreditCard_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		CreditCard_ROLE_C.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_C_channel_ROLE_M_Client_Insecure, CreditCard_Steps.STEP_0);
