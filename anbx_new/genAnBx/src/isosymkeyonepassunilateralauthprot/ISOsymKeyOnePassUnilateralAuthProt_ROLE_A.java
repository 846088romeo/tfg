...
public final class ISOsymKeyOnePassUnilateralAuthProt_ROLE_A extends AnB_Protocol<ISOsymKeyOnePassUnilateralAuthProt_Steps,ISOsymKeyOnePassUnilateralAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyOnePassUnilateralAuthProt_ROLE_A(ISOsymKeyOnePassUnilateralAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyOnePassUnilateralAuthProt_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, ISOsymKeyOnePassUnilateralAuthProt_Steps.STEP_0);
