...
public final class Secret_Pair_ROLE_A extends AnB_Protocol<Secret_Pair_Steps,Secret_Pair_Roles> {
...
//	private static boolean loop = false;
	...
	public Secret_Pair_ROLE_A(Secret_Pair_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Secret_Pair_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Secret_Pair_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, Secret_Pair_Steps step) {
		...
		case STEP_0:
			...
			s.Send(new AnBx_Params(Msg1,Msg2));
