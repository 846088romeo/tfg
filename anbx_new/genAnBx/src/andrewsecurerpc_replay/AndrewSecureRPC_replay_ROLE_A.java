...
//	private static boolean loop = false;
	...
	private Crypto_ByteArray VAR_A_J12DSAR3ASHKAB = null;
	private Crypto_ByteArray VAR_A_J22DSAR3ASHKAB = null;
	...
	protected void executeStep(AnB_Session s, AndrewSecureRPC_replay_Steps step) {
		...
		case STEP_3:
			...
			VAR_A_J12DSAR3ASHKAB = (Crypto_ByteArray) new AnBx_Params((AnBx_Params) s.decrypt(VAR_A_R3,VAR_A_SHKAB)).getValue(0);
			wffCheck("3.1",VAR_A_J12DSAR3ASHKAB);
			eqCheck("3.2",succ(s,NA),VAR_A_J12DSAR3ASHKAB);

			break;
		
		case STEP_4:
			
			VAR_A_J22DSAR3ASHKAB = (Crypto_ByteArray) new AnBx_Params((AnBx_Params) s.decrypt(VAR_A_R3,VAR_A_SHKAB)).getValue(1);
			s.Send(s.encrypt(succ(s,VAR_A_J22DSAR3ASHKAB),VAR_A_SHKAB));
		...
		case STEP_7:
			...
			wffCheck("7.1",VAR_A_J22DSAR3ASHKAB);
