...
public final class TLS_noClientAuth_Functions {
	...
	public static SecretKey clientK(AnB_Session s,Crypto_ByteArray par1,Crypto_ByteArray par2,Crypto_ByteArray par3) {
		// TODO Auto-generated method stub
		
		return (SecretKey) s.getSymmetricKeyPBE(par1.toString()+par2.toString()+par3.toString(),par3.toString()+par2.toString()+par1.toString());
	}
	
	public static SecretKey serverK(AnB_Session s,Crypto_ByteArray par1,Crypto_ByteArray par2,Crypto_ByteArray par3) {
		// TODO Auto-generated method stub
		
		return (SecretKey) s.getSymmetricKeyPBE(par1.toString()+par2.toString()+par3.toString(),par3.toString()+par2.toString()+par1.toString());
	}
	
	public static Crypto_ByteArray prf(AnB_Session s,Crypto_ByteArray par1,Crypto_ByteArray par2,Crypto_ByteArray par3) {
		// TODO Auto-generated method stub
		
		return (Crypto_ByteArray) new Crypto_ByteArray(Integer.toString(par1.hashCode()+par2.hashCode()+par3.hashCode()).getBytes());
	}
