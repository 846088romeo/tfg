...
public final class AnBx_Fresh_from_A_ROLE_A extends AnB_Protocol<AnBx_Fresh_from_A_Steps,AnBx_Fresh_from_A_Roles> {
...
//	private static boolean loop = false;
	...
	private Crypto_ByteArray SQNx1 = null;
	
	
	public AnBx_Fresh_from_A_ROLE_A(AnBx_Fresh_from_A_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AnBx_Fresh_from_A_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, AnBx_Fresh_from_A_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, AnBx_Fresh_from_A_Steps step) {
		...
		case STEP_0:
			...
			SQNx1 = s.getSeqNumber();
			s.Send(s.sign(new AnBx_Params(Msg,SQNx1,aliases.get("ROLE_B"))));
