...
public final class TypeConv_ROLE_A extends AnB_Protocol<TypeConv_Steps,TypeConv_Roles> {
...
//	private static boolean loop = false;
	...
	private Crypto_ByteArray Msg1 = null;
	private IntNum Msg3 = null;
	private SecretKey VAR_A_SHKAB = null;
	private AnBx_Params VAR_A_R1 = null;
	
	
	public TypeConv_ROLE_A(TypeConv_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		TypeConv_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, TypeConv_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, TypeConv_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, TypeConv_Steps step) {
		...
		case STEP_0:
			...
			Msg3 = new IntNum();
			VAR_A_SHKAB = ShkAB;
			s.Send(s.encrypt(new AnBx_Params(Msg1,s.encrypt(Msg3,VAR_A_SHKAB)),VAR_A_SHKAB));
		...
		case STEP_1:
			...
			eqCheck("1.1",Msg1,(Crypto_ByteArray) VAR_A_R1.getValue(1));
			eqCheck("1.2",Msg1,(Crypto_ByteArray) s.decrypt((SealedObject) VAR_A_R1.getValue(0),VAR_A_SHKAB));
			eqCheck("1.3",Msg3,(IntNum) VAR_A_R1.getValue(2));
