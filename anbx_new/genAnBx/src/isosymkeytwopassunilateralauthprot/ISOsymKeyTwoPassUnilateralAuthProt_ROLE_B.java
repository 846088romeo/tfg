...
public final class ISOsymKeyTwoPassUnilateralAuthProt_ROLE_B extends AnB_Protocol<ISOsymKeyTwoPassUnilateralAuthProt_Steps,ISOsymKeyTwoPassUnilateralAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassUnilateralAuthProt_ROLE_B(ISOsymKeyTwoPassUnilateralAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassUnilateralAuthProt_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Client_Insecure, ISOsymKeyTwoPassUnilateralAuthProt_Steps.STEP_0);
					executeStep(ROLE_B_channel_ROLE_A_Client_Insecure, ISOsymKeyTwoPassUnilateralAuthProt_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassUnilateralAuthProt_Steps step) {
		...
		case STEP_1:
			...
			eqCheck("1.1",aliases.get("ROLE_B"),(String) VAR_B_DSBR1SHKAB.getValue(1));
			eqCheck("1.2",NB,(Crypto_ByteArray) VAR_B_DSBR1SHKAB.getValue(0));
