...
public final class ISOsymKeyTwoPassUnilateralAuthProt_ROLE_A extends AnB_Protocol<ISOsymKeyTwoPassUnilateralAuthProt_Steps,ISOsymKeyTwoPassUnilateralAuthProt_Roles> {
...
//	private static boolean loop = false;
	...
	public ISOsymKeyTwoPassUnilateralAuthProt_ROLE_A(ISOsymKeyTwoPassUnilateralAuthProt_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ISOsymKeyTwoPassUnilateralAuthProt_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Server_Insecure, ISOsymKeyTwoPassUnilateralAuthProt_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Server_Insecure, ISOsymKeyTwoPassUnilateralAuthProt_Steps.STEP_1);
	...
	protected void executeStep(AnB_Session s, ISOsymKeyTwoPassUnilateralAuthProt_Steps step) {
		...
		case STEP_1:
			...
			s.Send(s.encrypt(new AnBx_Params(VAR_A_R0,aliases.get("ROLE_B"),Text2),ShkAB));
