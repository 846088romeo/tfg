...
public final class Fresh_from_A_with_DH_ROLE_A extends AnB_Protocol<Fresh_from_A_with_DH_Steps,Fresh_from_A_with_DH_Roles> {
...
//	private static boolean loop = false;
	...
	public Fresh_from_A_with_DH_ROLE_A(Fresh_from_A_with_DH_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Fresh_from_A_with_DH_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_from_A_with_DH_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_from_A_with_DH_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, Fresh_from_A_with_DH_Steps.STEP_2);
