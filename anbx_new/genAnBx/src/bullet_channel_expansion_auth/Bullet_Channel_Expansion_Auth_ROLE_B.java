...
public final class Bullet_Channel_Expansion_Auth_ROLE_B extends AnB_Protocol<Bullet_Channel_Expansion_Auth_Steps,Bullet_Channel_Expansion_Auth_Roles> {
...
//	private static boolean loop = false;
	...
	public Bullet_Channel_Expansion_Auth_ROLE_B(Bullet_Channel_Expansion_Auth_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		Bullet_Channel_Expansion_Auth_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Authentic, Bullet_Channel_Expansion_Auth_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, Bullet_Channel_Expansion_Auth_Steps step) {
