...
public final class WooLam1Test_ROLE_A extends AnB_Protocol<WooLam1Test_Steps,WooLam1Test_Roles> {
...
//	private static boolean loop = false;
	...
	public WooLam1Test_ROLE_A(WooLam1Test_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		WooLam1Test_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1Test_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1Test_Steps.STEP_1);
					executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, WooLam1Test_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, WooLam1Test_Steps step) {
		...
		case STEP_2:
			...
			s.Send(s.encrypt(new AnBx_Params(tag,aliases.get("ROLE_B"),VAR_A_R1),ShkAs));
