...
public final class ShareAgreeSimple_ROLE_B extends AnB_Protocol<ShareAgreeSimple_Steps,ShareAgreeSimple_Roles> {
...
//	private static boolean loop = false;
	...
	public ShareAgreeSimple_ROLE_B(ShareAgreeSimple_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
    ...
    protected void init() {
        ...
        // init shared vars
         NB = (Crypto_ByteArray) AnB_Session.readObject(sharepath+"NB.ser");
		};
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		ShareAgreeSimple_ROLE_B.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_B_channel_ROLE_A_Server_Insecure, ShareAgreeSimple_Steps.STEP_0);
	...
	protected void executeStep(AnB_Session s, ShareAgreeSimple_Steps step) {
