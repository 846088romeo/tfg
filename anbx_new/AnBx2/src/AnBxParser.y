...
action :: {AnBxAction}
  : channel ":" msg "%" msg "!" msg 
     {($1,PlainMsg $3,Just $5,Just $7)}
  | channel ":" msg "%" msg 
     {($1,PlainMsg $3,Just $5,Nothing)}
  | channel ":" msg 
     {($1,PlainMsg $3,Nothing,Nothing)}
  | channel ":" "~" msg "%" msg "!" msg 
     {($1,ReplayMsg $4,Just $6,Just $8)}
  | channel ":" "~" msg "%" msg 
     {($1,ReplayMsg $4,Just $6,Nothing)}
  | channel ":" "~" msg 
     {($1,ReplayMsg $4,Nothing,Nothing)}
