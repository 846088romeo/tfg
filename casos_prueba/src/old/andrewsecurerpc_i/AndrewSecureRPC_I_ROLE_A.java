...
public final class AndrewSecureRPC_I_ROLE_A extends AnB_Protocol<AndrewSecureRPC_I_Steps,AndrewSecureRPC_I_Roles> {
...
//	private static boolean loop = false;
	...
	public AndrewSecureRPC_I_ROLE_A(AndrewSecureRPC_I_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AndrewSecureRPC_I_ROLE_A.sessions = sessions;
		...
		do {
			...
			try {
                    ...
                    executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_I_Steps.STEP_0);
					executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_I_Steps.STEP_3);
					executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_I_Steps.STEP_4);
					executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_I_Steps.STEP_7);
